...
void MX_USART2_UART_Init(void)
{
  ...
  huart2.Init.WordLength = UART_WORDLENGTH_9B; // 8E1 requires 9-bit word length in STM32 HAL
...
void MX_USART3_UART_Init(void)
{
  ...
  huart3.Init.WordLength = UART_WORDLENGTH_9B; // 8 data bits + even parity
